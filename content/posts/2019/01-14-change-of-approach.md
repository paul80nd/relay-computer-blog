...
I've uploaded [the schematics](/pdf/backplane-y-v1.pdf) and [PCB layers](/pdf/backplane-y-v1-pcb.pdf) in PDF format so you can have a closer look if you like but I'll leave this post there for now. Next time I'll have a go at actually making this PCB and so that you can witness the disaster/success unfold I'll record a video covering the whole process.
